<template>
  <div class="tree-contanier" id="tree" ref="treeContainer">
    <h2 style="margin-top: 5px;color: #124880;">|&emsp;OBOM（服务BOM）结构树</h2>
    <el-row>
      <el-col :span="24" class="chart chart_left">
        <div id="treeChart" style="height: 450px">OBOM（服务BOM）结构树加载失败</div>
      </el-col>
    </el-row>
    <el-divider></el-divider>
    <h2 style="float: left; margin-top:5px;color: #124880;">|&emsp;OBOM（服务BOM）数据表格</h2>
...
<!--                  <el-button @click="" type="success" size="small"-->
<!--                  >修改关联关系-->
<!--                  </el-button>-->
...
<!--              </el-table-column>-->
      ...
      <div style="float: left;margin-left:45px; width:98%" v-if="dialogStatus == 'create'">
        ...
        <div style="margin-top: 10px;">
          <el-button type="primary" @click="handleConnectONode" size="small">
            选择OBOM的节点
          </el-button>
          <el-button type="primary" @click="handleConnectSNode" size="small">
            选择SBOM的节点
          </el-button>
<!--          <el-button type="primary" @click="handleConnectDNode" size="small">-->
<!--            选择DBOM的节点-->
<!--          </el-button>-->
          <el-button type="primary" @click="handleConnectBNode" size="small">
            选择BBOM的节点
          </el-button>
          <el-button type="primary" @click="handleConnectMNode" size="small">
            选择MBOM的节点
          </el-button>
      ...
      <div slot="footer" class="dialog-footer" style="margin-top: 50px">
        <el-upload class="upload-demo inline-block" ref="upload" :multiple="true" style="float: left;margin-left: 62%"
                   ...
                   action="/BOMFile/dataFile/uploadOBomFile" :on-preview="handlePreview"
    ...
    <el-dialog
      ...
      <div>
        ...
        <!-- </el-form-item> -->
        <el-select v-model="connectRelationSelect" ref="mySelected1" placeholder="选择关联关系" style="width: 150px"
                   size="medium">
          <el-option
    ...
    <el-dialog
      ...
      <!-- prop="children" :label-width="formLabelWidth" :label-positon="labelPositon"> -->
      <div>
        <el-cascader ref="cascaderMallCatergorySt" size="medium" :key="isResouceShow" v-model="temp.children2"
                     placeholder="请选择,可输入关键字进行搜索"
                     :options="tableStBomData" :props="TagProps" clearable filterable
                     class="elcascader"></el-cascader>
        <!-- </el-form-item> -->
        <el-select v-model="connectRelationSelect" ref="mySelected2" placeholder="选择关联关系" style="width: 150px"
                   size="medium">
          <el-option
            v-for="item in connectOptions"
            :key="item.connectValue"
    ...
    <el-dialog
      ...
      <!-- prop="children" :label-width="formLabelWidth" :label-positon="labelPositon"> -->
      <div>
        <el-cascader ref="cascaderMallCatergoryE" size="medium" :key="isResouceShow" v-model="temp.children3"
                     placeholder="请选择,可输入关键字进行搜索"
    ...
    <el-dialog
      title="关联关系添加页面"
      :visible.sync="visitMBOM"
      width="72%"
      :before-close="handleClose">
      <!-- <h4>关联节点选择</h4> -->
      <h3 style="font-weight: 700;color: #0D5599;margin-bottom: 10px;">| 请选择MBOM(制造BOM)中需要关联的节点位置：</h3>
      <!-- <el-form-item  label="请选择定义BOM(DfBOM)的节点位置：" -->
      <!-- prop="children" :label-width="formLabelWidth" :label-positon="labelPositon"> -->
      <div>
        <el-cascader ref="cascaderMallCatergoryM" size="medium" :key="isResouceShow" v-model="temp.children4"
                     placeholder="请选择,可输入关键字进行搜索"
                     :options="tableMBomData" :props="TagProps" clearable filterable
                     class="elcascader"></el-cascader>
        <!-- </el-form-item> -->
        <el-select v-model="connectRelationSelect" ref="mySelected2" placeholder="选择关联关系" style="width: 150px"
                   size="medium">
        ...
        <el-button type="primary" size="medium" @click="handleMCatergoryChange">查看节点属性信息</el-button>
      </div>
      ...
      <div style="margin-left: 76%;margin-top: 20px">
			<span slot="footer" class="dialog-footer">
		    <el-button type="primary" @click="connectMBom" size="small">关联节点</el-button>
		  </span>
      </div>
    </el-dialog>
    <!-- 选择关联节点信息和数据结束 -->
    ...
    <el-dialog
      title="关联关系添加页面"
      :visible.sync="visitBBOM"
      width="72%"
      :before-close="handleClose">
      <!-- <h4>关联节点选择</h4> -->
      <h3 style="font-weight: 700;color: #0D5599;margin-bottom: 10px;">| 请选择BBOM(装机BOM)中需要关联的节点位置：</h3>
      <!-- <el-form-item  label="请选择定义BOM(DfBOM)的节点位置：" -->
      <!-- prop="children" :label-width="formLabelWidth" :label-positon="labelPositon"> -->
      <div>
        <el-cascader ref="cascaderMallCatergoryB" size="medium" :key="isResouceShow" v-model="temp.children5"
                     placeholder="请选择,可输入关键字进行搜索"
                     :options="tableBBomData" :props="TagProps" clearable filterable
                     class="elcascader"></el-cascader>
        <!-- </el-form-item> -->
        <el-select v-model="connectRelationSelect" ref="mySelected2" placeholder="选择关联关系" style="width: 150px"
                   size="medium">
        ...
        <el-button type="primary" size="medium" @click="handleBCatergoryChange">查看节点属性信息</el-button>
      </div>
      ...
      <div style="margin-left: 76%;margin-top: 20px">
			<span slot="footer" class="dialog-footer">
		    <el-button type="primary" @click="connectBBom" size="small">关联节点</el-button>
		  </span>
      </div>
    </el-dialog>
    <!-- 选择关联节点信息和数据结束 -->
    ...
    <el-dialog
      title="关联关系添加页面"
      :visible.sync="visitSBOM"
      width="72%"
      :before-close="handleClose">
      <!-- <h4>关联节点选择</h4> -->
      <h3 style="font-weight: 700;color: #0D5599;margin-bottom: 10px;">| 请选择SBOM(服务BOM)中需要关联的节点位置：</h3>
      <div>
        <el-cascader ref="cascaderMallCatergoryS" size="medium" :key="isResouceShow" v-model="temp.children6"
                     placeholder="请选择,可输入关键字进行搜索"
                     :options="tableSBomData" :props="TagProps" clearable filterable
                     class="elcascader"></el-cascader>
        <!-- </el-form-item> -->
        <el-select v-model="connectRelationSelect" ref="mySelected2" placeholder="选择关联关系" style="width: 150px"
                   size="medium">
        ...
        <el-button type="primary" size="medium" @click="handleSCatergoryChange">查看节点属性信息</el-button>
      </div>
      ...
      <div style="margin-left: 76%;margin-top: 20px">
			<span slot="footer" class="dialog-footer">
		    <el-button type="primary" @click="connectSBom" size="small">关联节点</el-button>
		  </span>
      </div>
    </el-dialog>
    <!-- 选择关联节点信息和数据结束 -->
    ...
    <el-dialog
      title="关联关系添加页面"
      :visible.sync="visitOBOM"
      width="72%"
      :before-close="handleClose">
      <!-- <h4>关联节点选择</h4> -->
      <h3 style="font-weight: 700;color: #0D5599;margin-bottom: 10px;">| 请选择OBOM(运营BOM)中需要关联的节点位置：</h3>
      <div>
        <el-cascader ref="cascaderMallCatergoryO" size="medium" :key="isResouceShow" v-model="temp.children7"
                     placeholder="请选择,可输入关键字进行搜索"
                     :options="tableOBomData" :props="TagProps" clearable filterable
                     class="elcascader"></el-cascader>
        <!-- </el-form-item> -->
        <el-select v-model="connectRelationSelect" ref="mySelected2" placeholder="选择关联关系" style="width: 150px"
                   size="medium">
        ...
        <el-button type="primary" size="medium" @click="handleOCatergoryChange">查看节点属性信息</el-button>
      </div>
      ...
      <div style="margin-left: 76%;margin-top: 20px">
			<span slot="footer" class="dialog-footer">
		    <el-button type="primary" @click="connectOBom" size="small">关联节点</el-button>
		  </span>
      </div>
    </el-dialog>
    <!-- 选择关联节点信息和数据结束 -->
    ...
    <el-dialog title="关联关系添加页面" :visible.sync="visitOutBOM" width="85%" :before-close="handleClose">
      ...
      <div>
        <el-cascader ref="cascaderMallCatergoryOut" size="medium" :key="isResouceShow" v-model="temp.children8"
    ...
    export default {
        ...
        data() {
            return {
                ...
                alignDir: 'center',
                textMap: {
                    update: '编辑运营BOM(OBOM)节点信息',
                    create: '添加运营BOM(OBOM)节点信息',
                },
                dialogStatus: '',
        ...
        methods: {
            ...
            loadFileForm(fileValue) {
                this.getRequest("/BOMFile/dataFile/findOBomFileByPage?page=" + this.currentPage +
                    "&size=" + this.pageSize +
            ...
            downLoadFile(index, row) {
                ...
                this.apiDownLoad("/BOMFile/dataFile/downloadOBomFileByName?fileId=" + fileId + "&fileName=" + fileName, {responseType: 'blob'}).then(
                    resp => {
            ...
            deleteFile(index, row) {
                ...
                this.postRequest("/BOMFile/dataFile/deleteOBomFile?fileId=" + id).then(resp => {
                    if (resp && resp.status == 200) {
                        this.loadFileForm();
                    } else {
                        this.$message({
                    ...
                    if (valid) {
                        if (this.sonStatus == false) {
                            ...
                            if (this.casArr[this.casArr.length - 1].includes('A')) {
                              this.temp.value =
                                String('H' +String(this.casArr[this.casArr.length - 1]).slice(1)) + '-' +
                                String(arr.length);
                              ...
                              this.temp.value =
                                String('H' + this.casArr[this.casArr.length - 1]) + '-' +
                                String(arr.length);
                            }
            ...
            saveUpdateDataJSON() {
                ...
                this.$http({
                    ...
                    if (resp && resp.status == 200) {
                        ...
                        ;
                        // lwy  调用新增发布方法
                        this.publishAddNode("obom_infomation",this.conStBomId)
                        // lwy 新增的节点信息 发布结束
                        this.$message({
                            type: 'success',
            ...
            async getTableDataLate() {
                await this.$http({
                    method: 'get',
                    url: "/obom/data/getTableDataLate",
                    headers: {
                        'Content-Type': 'application/json',
                        'Access-Control-Allow-Origin': '*'
                    }
            ...
            handleUpdate(index, row) {
                ...
                //获取关联节点
                this.getRequest("/obom/data/selectConnectInfo?selectId=" + row.value).then(resp => {
                    if (resp && resp.status == 200) {
                        console.log(resp);
            ...
            getBBOMDataLate() {
                this.$http({
                    method: 'get',
                    url: "/bbom/data/getTableDataLate",
                    headers: {
                        'Content-Type': 'application/json',
                        'Access-Control-Allow-Origin': '*'
                    }
                    ...
                    if (resp && resp.status == 200) {
                        this.tableDataRetrun = resp.data.message;
                        // console.log("后端返回的最新的数据为---------" + this.tableDataRetrun);
                        this.tableBBomData = JSON.parse(this.tableDataRetrun);
                        this.$message({
                            type: 'success',
                            message: '节点信息获取成功！',
                        })
            ...
            getDBOMDataLate() {
                this.$http({
                    method: 'get',
                    url: "/dbom/data/getTableDataLate",
                    headers: {
                        'Content-Type': 'application/json',
                        'Access-Control-Allow-Origin': '*'
                    }
                    ...
                    if (resp && resp.status == 200) {
                        this.tableDataRetrun = resp.data.message;
                        // console.log("后端返回的最新的数据为---------" + this.tableDataRetrun);
                        this.tableDBomData = JSON.parse(this.tableDataRetrun);
                        this.$message({
                            type: 'success',
                            message: '节点信息获取成功！',
                        })
            ...
            getSBOMDataLate() {
                this.$http({
                    method: 'get',
                    url: "/sbom/data/getTableDataLate",
                    headers: {
                        'Content-Type': 'application/json',
                        'Access-Control-Allow-Origin': '*'
                    }
                    ...
                    if (resp && resp.status == 200) {
                        this.tableDataRetrun = resp.data.message;
                        // console.log("后端返回的最新的数据为---------" + this.tableDataRetrun);
                        this.tableSBomData = JSON.parse(this.tableDataRetrun);
                        this.$message({
                            type: 'success',
                            message: '节点信息获取成功！',
                        })
            ...
            getOBOMDataLate() {
                this.$http({
                    ...
                    if (resp && resp.status == 200) {
                        this.tableDataRetrun = resp.data.message;
                        // console.log("后端返回的最新的数据为---------" + this.tableDataRetrun);
                        this.tableOBomData = JSON.parse(this.tableDataRetrun);
                        this.$message({
                            type: 'success',
                            message: '节点信息获取成功！',
                        })
            ...
            handleStCatergoryChange() {
                if (this.temp.children2.length != 0) {
                    var arr2 = this.$refs['cascaderMallCatergorySt'].getCheckedNodes()[0].pathLabels;
                    var arrValue2 = this.$refs['cascaderMallCatergorySt'].value;
            ...
            connectStBom(){
                if(this.$refs['cascaderMallCatergorySt'].getCheckedNodes()[0] == null){
                    this.$message({
                        message: '请选择关联节点',
                        type: 'warning'
                    });
            ...
            handleECatergoryChange() {
                if (this.temp.children3.length != 0) {
                    var arr2 = this.$refs['cascaderMallCatergoryE'].getCheckedNodes()[0].pathLabels;
                    var arrValue2 = this.$refs['cascaderMallCatergoryE'].value;
                    var connectRela = this.$refs.mySelected2.value;
                    this.stBomArrayElementValue = arrValue2[arrValue2.length - 1];//选中关联节点名称对应的内编码
                    this.stBomArrayElement = arr2[arr2.length - 1];//获取数组最后一个元素
            ...
            connectEBom(){
              if(this.$refs['cascaderMallCatergoryE'].getCheckedNodes()[0] == null){
                  this.$message({
                      message: '请选择关联节点',
                      type: 'warning'
                  });
            ...
            handleMCatergoryChange() {
                if (this.temp.children4.length != 0) {
                    var arr2 = this.$refs['cascaderMallCatergoryM'].getCheckedNodes()[0].pathLabels;
                    var arrValue2 = this.$refs['cascaderMallCatergoryM'].value;
                    var connectRela = this.$refs.mySelected2.value;
                    this.stBomArrayElementValue = arrValue2[arrValue2.length - 1];//选中关联节点名称对应的内编码
                    this.stBomArrayElement = arr2[arr2.length - 1];//获取数组最后一个元素
                    this.getRequest("/mbom/data/getOneNodeInfo?stBomArrayElement=" + this.stBomArrayElement).then(resp => {
                        if (resp && resp.status == 200) {
                            console.log(resp);
                            this.stBomArray = resp.data.oneNodeInfo;
                            this.stBomInfo = this.stBomArray[0];
            ...
            connectMBom(){
                if(this.$refs['cascaderMallCatergoryM'].getCheckedNodes()[0] == null){
                    this.$message({
                        message: '请选择关联节点',
                        type: 'warning'
                    });
                ...
                fileURLStore.setItem("connectInfoListSt", this.connectInfoListSt);
                this.visitMBOM = false;
            },

            handleBCatergoryChange() {
                if (this.temp.children5.length != 0) {
                    var arr2 = this.$refs['cascaderMallCatergoryB'].getCheckedNodes()[0].pathLabels;
                    var arrValue2 = this.$refs['cascaderMallCatergoryB'].value;
                    var connectRela = this.$refs.mySelected2.value;
                    this.stBomArrayElementValue = arrValue2[arrValue2.length - 1];//选中关联节点名称对应的内编码
                    this.stBomArrayElement = arr2[arr2.length - 1];//获取数组最后一个元素
                    this.getRequest("/bbom/data/getOneNodeInfo?stBomArrayElement=" + this.stBomArrayElement).then(resp => {
                        if (resp && resp.status == 200) {
                            console.log(resp);
                            this.stBomArray = resp.data.oneNodeInfo;
                            this.stBomInfo = this.stBomArray[0];
            ...
            connectBBom(){
                if(this.$refs['cascaderMallCatergoryB'].getCheckedNodes()[0] == null){
                    this.$message({
                        message: '请选择关联节点',
                        type: 'warning'
                    });
                ...
                fileURLStore.setItem("connectInfoListSt", this.connectInfoListSt);
                this.visitBBOM = false;
            },

            handleSCatergoryChange() {
                if (this.temp.children6.length != 0) {
                    var arr2 = this.$refs['cascaderMallCatergoryS'].getCheckedNodes()[0].pathLabels;
                    var arrValue2 = this.$refs['cascaderMallCatergoryS'].value;
                    var connectRela = this.$refs.mySelected2.value;
                    this.stBomArrayElementValue = arrValue2[arrValue2.length - 1];//选中关联节点名称对应的内编码
                    this.stBomArrayElement = arr2[arr2.length - 1];//获取数组最后一个元素
                    this.getRequest("/sbom/data/getOneNodeInfo?stBomArrayElement=" + this.stBomArrayElement).then(resp => {
                        if (resp && resp.status == 200) {
                            console.log(resp);
                            this.stBomArray = resp.data.oneNodeInfo;
                            this.stBomInfo = this.stBomArray[0];
            ...
            connectSBom(){
                if(this.$refs['cascaderMallCatergoryS'].getCheckedNodes()[0] == null){
                    this.$message({
                        message: '请选择关联节点',
                        type: 'warning'
                    });
                ...
                fileURLStore.setItem("connectInfoListSt", this.connectInfoListSt);
                this.visitSBOM = false;
            },

            handleOCatergoryChange() {
                if (this.temp.children7.length != 0) {
                    var arr2 = this.$refs['cascaderMallCatergoryO'].getCheckedNodes()[0].pathLabels;
                    var arrValue2 = this.$refs['cascaderMallCatergoryO'].value;
                    var connectRela = this.$refs.mySelected2.value;
                    this.stBomArrayElementValue = arrValue2[arrValue2.length - 1];//选中关联节点名称对应的内编码
                    this.stBomArrayElement = arr2[arr2.length - 1];//获取数组最后一个元素
                    this.getRequest("/obom/data/getOneNodeInfo?stBomArrayElement=" + this.stBomArrayElement).then(resp => {
                        if (resp && resp.status == 200) {
                            console.log(resp);
                            this.stBomArray = resp.data.oneNodeInfo;
                            this.stBomInfo = this.stBomArray[0];
            ...
            connectOBom(){
                if(this.$refs['cascaderMallCatergoryO'].getCheckedNodes()[0] == null){
                    this.$message({
                        message: '请选择关联节点',
                        type: 'warning'
                    });
                ...
                fileURLStore.setItem("connectInfoListSt", this.connectInfoListSt);
                this.visitOBOM = false;
            },

            //获取所选中的外部应用数据节点的label
            handleMallCatergoryChangeOut() {
                if (this.temp.children8.length != 0) {
            ...
            sentConnectInfo() {
                ...
                this.$http({
                    method: 'post',
                    url: "/obom/data/saveStConnectData",
            ...
            uploadFile(row) {
                ...
                this.uploadFileRequest("/BOMFile/dataFile/uploadOBomFile", uploadForm).then(resp => {
                    this.fileList = [];
            ...
            selectFile() {
                if (this.dfBomArrayElement == '' || this.dfBomArrayElement == null) {
                    ...
                    this.getRequest("/BOMFile/dataFile/selectOBomFile?dfBomNodeName=" + dfNodeName).then(resp => {
                        if (resp && resp.status == 200) {
            ...
            selectStFile() {
                if (this.stBomArrayElement == '' || this.stBomArrayElement == null) {
                    ...
                    this.getRequest("/BOMFile/dataFile/selectOBomFile?stBomNodeName=" + stNodeName).then(resp => {
                        if (resp && resp.status == 200) {
                            if (resp.data.fileName != null || this.fileName != '') {
                                this.fileName = resp.data.fileName;
                                this.downLoadStFile();
            ...
            downLoadStFile() {
                ...
                this.apiDownLoad("/BOMFile/dataFile/downloadOBomFileByName?fileName=" + this.fileName).then(
                    resp => {
                        var blob = new Blob([resp], {
                            type: "application/octet-stream"
                        });
            ...
            handleConnectBNode() {
                ...
                this.stBomInfo = [];            //属性信息删除
                this.visitBBOM = true;
                this.getBBOMDataLate();
            },

            //处理关联节点开始DBOM
            handleConnectDNode() {
                this.visitDBOM = true;
                this.getDBOMDataLate();
            },
        ...
        */
            ...
            sendrequestChange(row) {
                ...
                var tablename = 'obom_infomation';
                var Associationtablename = 'obom_connect_info';
            ...
            associationChange(row) {
                var submitintracoding = row.value;
                var tablename = 'obom_connect_info';
                ...
                this.getRequest("/bomTree/associationDelete?submitNodeintracoding=" + submitNodeintracoding + "&submitintracoding=" + submitintracoding + "&tablename=" + tablename)
                    .then(resp => {
                        if (resp.data.deleteNum > 0 && resp.status == 200) {
                            ...
                            this.getRequest("/obom/data/selectConnectInfo?selectId=" + row.connectId).then(resp => {
                                if (resp && resp.status == 200) {
                                    console.log(resp);
                                    this.connectInfoTable = resp.data.connectInfos;
                                    this.$message({
