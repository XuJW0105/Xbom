<template>
  <div class="tree-contanier" id="tree" ref="treeContainer">
    <h2 style="margin-top: 5px;color: #124880;">|&emsp;DBOM（发运BOM）结构树</h2>
    <el-row>
      <el-col :span="24" class="chart chart_left">
        <div id="treeChart" style="height: 450px">DBOM（发运BOM）结构树加载失败</div>
      </el-col>
    </el-row>
    <el-divider></el-divider>
    <h2 style="float: left; margin-top:5px;color: #124880;">|&emsp;DBOM（发运BOM）数据表格</h2>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" width="70%">
          ...
          <el-form :inline="true" :model="form" ref="form" style="margin-top: 3%">
            <div v-for="(item, index) in form.head" :key="index" style="float: left;margin-left:2.5%;">
              ...
              <el-form-item label="属性内容:" :label-width="formLabelWidth"
                ...
                <el-button type="danger" @click="del_head(index)" v-show="!(form.head.length == index + 1)"
                           size="small">删除属性信息
                </el-button>
              </el-form-item>
      ...
      <div slot="footer" class="dialog-footer" style="margin-top: 50px">
        <el-upload class="upload-demo inline-block" ref="upload" :multiple="true" style="float: left;margin-left: 62%"
                   ...
                   action="/BOMFile/dataFile/uploadDBomFile" :on-preview="handlePreview"
...
<!--			<el-button @click="selectStFile" type="primary" size="small">查看节点详细信息请下载源文件</el-button>-->
    ...
    <el-dialog
      ...
      <div>
        <el-cascader ref="cascaderMallCatergory" size="medium" :key="isResouceShow" v-model="temp.children"
                     placeholder="请选择,可输入关键字进行搜索"
                     :options="tableEBomData" :props="TagProps" clearable filterable @change="getCasVal"
                     class="elcascader"></el-cascader>
        <!-- </el-form-item> -->
        <el-select v-model="connectRelationSelect2" ref="mySelected2" placeholder="选择关联关系" style="width: 150px"
                   size="medium">
        ...
        <el-button type="primary" size="medium" @click="handleECatergoryChange">关联并查看属性信息</el-button>
      </div>
...
<!--			<el-button @click="selectStFile" type="primary" size="small">查看节点详细信息请下载源文件</el-button>-->
        ...
        <!--			<el-button type="danger" size="medium" @click="resetNodeProp">重置</el-button>-->
        <!-- <el-button @click="dialogVisible = false">取 消</el-button> -->
		    <el-button type="primary" @click="visitEBOM = false" size="small">关联完毕</el-button>
		  </span>
      </div>
    </el-dialog>
    <!-- 选择关联节点信息和数据结束 -->
    ...
    <el-dialog
      ...
      <div>
        <el-cascader ref="cascaderMallCatergory" size="medium" :key="isResouceShow" v-model="temp.children"
                     placeholder="请选择,可输入关键字进行搜索"
                     :options="tableMBomData" :props="TagProps" clearable filterable @change="getCasVal"
                     class="elcascader"></el-cascader>
        <!-- </el-form-item> -->
        <el-select v-model="connectRelationSelect2" ref="mySelected2" placeholder="选择关联关系" style="width: 150px"
                   size="medium">
        ...
        <el-button type="primary" size="medium" @click="handleMCatergoryChange">关联并查看属性信息</el-button>
      </div>
...
<!--			<el-button @click="selectStFile" type="primary" size="small">查看节点详细信息请下载源文件</el-button>-->
        ...
        <!--			<el-button type="danger" size="medium" @click="resetNodeProp">重置</el-button>-->
        <!-- <el-button @click="dialogVisible = false">取 消</el-button> -->
		    <el-button type="primary" @click="visitMBOM = false" size="small">关联完毕</el-button>
		  </span>
      </div>
    </el-dialog>
    <!-- 选择关联节点信息和数据结束 -->
    ...
    <el-dialog
      ...
      <div>
        <el-cascader ref="cascaderMallCatergory" size="medium" :key="isResouceShow" v-model="temp.children"
                     placeholder="请选择,可输入关键字进行搜索"
                     :options="tableBBomData" :props="TagProps" clearable filterable @change="getCasVal"
                     class="elcascader"></el-cascader>
        <!-- </el-form-item> -->
        <el-select v-model="connectRelationSelect2" ref="mySelected2" placeholder="选择关联关系" style="width: 150px"
                   size="medium">
        ...
        <el-button type="primary" size="medium" @click="handleBCatergoryChange">关联并查看属性信息</el-button>
      </div>
...
<!--			<el-button @click="selectStFile" type="primary" size="small">查看节点详细信息请下载源文件</el-button>-->
        ...
        <!--			<el-button type="danger" size="medium" @click="resetNodeProp">重置</el-button>-->
        <!-- <el-button @click="dialogVisible = false">取 消</el-button> -->
		    <el-button type="primary" @click="visitBBOM = false" size="small">关联完毕</el-button>
		  </span>
      </div>
    </el-dialog>
    <!-- 选择关联节点信息和数据结束 -->
    ...
    <el-dialog
      title="关联关系添加页面"
      :visible.sync="visitDBOM"
      width="72%"
      :before-close="handleClose">
      <!-- <h4>关联节点选择</h4> -->
      <h3 style="font-weight: 700;color: #0D5599;margin-bottom: 10px;">| 请选择DBOM(发运BOM)中需要关联的节点位置：</h3>
      <!-- <el-form-item  label="请选择定义BOM(DfBOM)的节点位置：" -->
      <!-- prop="children" :label-width="formLabelWidth" :label-positon="labelPositon"> -->
      <div>
        <el-cascader ref="cascaderMallCatergory" size="medium" :key="isResouceShow" v-model="temp.children"
                     placeholder="请选择,可输入关键字进行搜索"
                     :options="tableDBomData" :props="TagProps" clearable filterable @change="getCasVal"
                     class="elcascader"></el-cascader>
        <!-- </el-form-item> -->
        <el-select v-model="connectRelationSelect2" ref="mySelected2" placeholder="选择关联关系" style="width: 150px"
                   size="medium">
        ...
        <el-button type="primary" size="medium" @click="handleDCatergoryChange">关联并查看属性信息</el-button>
      </div>
...
<!--			<el-button @click="selectStFile" type="primary" size="small">查看节点详细信息请下载源文件</el-button>-->
        ...
        <!--			<el-button type="danger" size="medium" @click="resetNodeProp">重置</el-button>-->
        <!-- <el-button @click="dialogVisible = false">取 消</el-button> -->
		    <el-button type="primary" @click="visitDBOM = false" size="small">关联完毕</el-button>
		  </span>
      </div>
    </el-dialog>
    <!-- 选择关联节点信息和数据结束 -->
    ...
    <el-dialog title="关联关系添加页面" :visible.sync="visitOutBOM" width="85%" :before-close="handleClose">
      ...
      <!-- prop="children" :label-width="formLabelWidth" :label-positon="labelPositon"> -->
      <div>
        <el-cascader ref="cascaderMallCatergoryOut" size="medium" :key="isResouceShow" v-model="temp.children"
                     placeholder="请选择,可输入关键字进行搜索" :options="tableOutBomData" :props="TagProps" clearable filterable
                     @change="getCasVal" class="elcascader"></el-cascader>
        <!-- </el-form-item> -->
        ...
        <el-button type="primary" size="medium" @click="handleMallCatergoryChangeOut">关联并查看节点属性信息</el-button>
      </div>
      <!-- <el-divider></el-divider> -->
      <div style="float: left;margin-left: 0px;margin-top: 20px;margin-bottom: 10px;">
        <div style="float: left;margin-left: 0px;margin-top: 0px;"
      ...
      <div style="margin-left: 75%;margin-top: 10px">
				...
				<span slot="footer" class="dialog-footer">
					<!-- <el-button @click="" type="primary" size="small">查看节点详细信息请下载源文件</el-button> -->
          <!-- <el-button type="success" @click="">查看节点详细信息请下载源文件</el-button>  -->
					<el-button type="danger" size="small" @click="resetNodeProp">重置</el-button>
					<el-button @click="visitOutBOM = false" size="small" type="primary">关联完毕</el-button>
    ...
    export default {
        ...
        data() {
            return {
                ...
                alignDir: 'center',
                textMap: {
                    update: '编辑发运BOM(DBOM)节点信息',
                    create: '添加发运BOM(DBOM)节点信息',
                },
                dialogStatus: '',
        ...
        methods: {
            ...
            loadFileForm(fileValue) {
                this.getRequest("/BOMFile/dataFile/findDBomFileByPage?page=" + this.currentPage +
                    "&size=" + this.pageSize +
            ...
            downLoadFile(index, row) {
                ...
                this.apiDownLoad("/BOMFile/dataFile/downloadDBomFileByName?fileId=" + fileId + "&fileName=" + fileName, {responseType: 'blob'}).then(
                    resp => {
            ...
            deleteFile(index, row) {
                ...
                this.postRequest("/BOMFile/dataFile/deleteDBomFile?fileId=" + id).then(resp => {
                    if (resp && resp.status == 200) {
                        // this.loadFileForm();
                    } else {
                        this.$message({
                    ...
                    if (valid) {
                        if (this.sonStatus == false) {
                            ...
                            if (this.casArr[this.casArr.length - 1].includes('A')) {
                              this.temp.value =
                                String('F' +String(this.casArr[this.casArr.length - 1]).slice(1)) + '-' +
                                String(arr.length);
                              ...
                              this.temp.value =
                                String('F' + this.casArr[this.casArr.length - 1]) + '-' +
                                String(arr.length);
                            }
            ...
            saveUpdateDataJSON() {
                ...
                this.$http({
                    ...
                    if (resp && resp.status == 200) {
                        ...
                        ;
                        // lwy  调用新增发布方法
                        this.publishAddNode("dbom_infomation",this.conStBomId)
                        // lwy 新增的节点信息 发布结束
                        this.$message({
                            type: 'success',
            ...
            handleUpdate(index, row) {
                ...
                //获取关联节点
                this.getRequest("/dbom/data/selectConnectInfo?selectId=" + row.value).then(resp => {
                    if (resp && resp.status == 200) {
                        console.log(resp);
            ...
            handleDCatergoryChange() {
                if (this.temp.children.length != 0) {
                    ...
                    this.stBomArrayElement = arr2.pop();//获取数组最后一个元素
                    fileURLStore.setItem("connectInfoListSt", this.connectInfoListSt);
                    this.getRequest("/dbom/data/getOneNodeInfo?stBomArrayElement=" + this.stBomArrayElement).then(resp => {
                        if (resp && resp.status == 200) {
                            console.log(resp);
                            this.stBomArray = resp.data.oneNodeInfo;
                            this.stBomInfo = this.stBomArray[0];
            ...
            handleMallCatergoryChangeOut() {
                if (this.temp.children.length != 0) {
                    ...
                    console.log('arrValue3', arrValue3);
                    var connectRela = this.$refs.mySelectedOut.value;
                    this.outBomArrayElementValue = arrValue3.pop();
                    this.connectInfoListSt.push({
                        connectNodeName: arr3 + arr3.pop(),
                        connectNodeValue: this.outBomArrayElementValue,
                        connectRela: connectRela
                    });
                    this.outBomArrayElement = arr3.pop(); //获取数组最后一个元素
                    console.log('outBomArrayElement', this.outBomArrayElement);
                    console.log('outBomArrayElementValue', this.outBomArrayElementValue);
                    console.log('connectRela', connectRela);
                    fileURLStore.setItem("connectInfoListSt", this.connectInfoListSt);
                    ...
                    this.getRequest("/outbom/data/getOneNodeInfo3?stBomArrayElement=" + this.outBomArrayElement).then(
                        resp => {
                            if (resp && resp.status == 200) {
                                ...
                                console.log('name', this.outBomArray[0].name);
                            }
                        });
                }
            },
            ...
            sentConnectInfo() {
                ...
                this.$http({
                    method: 'post',
                    url: "/dbom/data/saveStConnectData",
            ...
            uploadFile(row) {
                ...
                this.uploadFileRequest("/BOMFile/dataFile/uploadDBomFile", uploadForm).then(resp => {
                    this.fileList = [];
                    if (resp && resp.status == 200) {
                        console.log(resp);
            ...
            selectFile() {
                if (this.dfBomArrayElement == '' || this.dfBomArrayElement == null) {
                    ...
                    this.getRequest("/BOMFile/dataFile/selectDBomFile?dfBomNodeName=" + dfNodeName).then(resp => {
                        if (resp && resp.status == 200) {
            ...
            selectStFile() {
                if (this.stBomArrayElement == '' || this.stBomArrayElement == null) {
                    ...
                    this.getRequest("/BOMFile/dataFile/selectDBomFile?stBomNodeName=" + stNodeName).then(resp => {
                        if (resp && resp.status == 200) {
                            if (resp.data.fileName != null || this.fileName != '') {
                                this.fileName = resp.data.fileName;
                                this.downLoadStFile();
            ...
            downLoadStFile() {
                ...
                this.apiDownLoad("/BOMFile/dataFile/downloadDBomFileByName?fileName=" + this.fileName).then(
                    resp => {
                        var blob = new Blob([resp], {
                            type: "application/octet-stream"
                        });
        ...
        */
            ...
            sendrequestChange(row) {
                ...
                var tablename = 'dbom_infomation';
                var Associationtablename = 'dbom_connect_info';
            ...
            associationChange(row) {
                var submitintracoding = row.value;
                var tablename = 'dbom_connect_info';
                ...
                this.getRequest("/bomTree/associationDelete?submitNodeintracoding=" + submitNodeintracoding + "&submitintracoding=" + submitintracoding + "&tablename=" + tablename)
                    .then(resp => {
                        if (resp.data.deleteNum > 0 && resp.status == 200) {
                            ...
                            this.getRequest("/dbom/data/selectConnectInfo?selectId=" + row.connectId).then(resp => {
                                if (resp && resp.status == 200) {
                                    console.log(resp);
                                    this.connectInfoTable = resp.data.connectInfos;
                                    this.$message({
