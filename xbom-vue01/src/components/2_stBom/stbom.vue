<template>
  <div class="tree-contanier" id="tree" ref="treeContainer">
    <h2 style="margin-top: 5px;color: #124880;">|&emsp;StBOM（系统BOM）结构树</h2>
    <el-row>
      <el-col :span="24" class="chart chart_left">
        <div id="treeChart" style="height: 450px">StBOM（系统BOM）结构树加载失败</div>
      </el-col>
    </el-row>
    <el-divider></el-divider>
    <h2 style="float: left; margin-top:5px;color: #124880;">|&emsp;StBOM（系统BOM）数据表格</h2>
...
<!--              </el-table-column>-->
    ...
    <el-dialog
      ...
      <!-- prop="children" :label-width="formLabelWidth" :label-positon="labelPositon"> -->
      <div>
        <el-cascader ref="cascaderMallCatergoryDf" size="medium" :key="isResouceShow" v-model="temp.children2"
      ...
      <div style="margin-left: 76%;margin-top: 20px">
		    ...
		    <el-button type="primary" @click="connectDfBom">关联完毕</el-button>
		  </span>
      </div>
    </el-dialog>
    <!-- 选择StBOM关联节点信息和数据开始 -->
    ...
    export default {
        ...
        data() {
            return {
                ...
                alignDir: 'center',
                textMap: {
                    update: '编辑系统BOM(StBOM)节点信息',
                    create: '添加系统BOM(StBOM)节点信息',
                },
                dialogStatus: '',
        ...
        methods: {
            ...
            downLoadFile(index, row) {
                ...
                this.apiDownLoad("/BOMFile/dataFile/downloadStBomFileByName?fileId=" + fileId + "&fileName=" + fileName, {responseType: 'blob'}).then(
                    resp => {
                    ...
                    if (valid) {
                        if (this.sonStatus == false) {
                            ...
                            if (this.casArr[this.casArr.length - 1].includes('A')) {
                              this.temp.value =
                                String('B' +String(this.casArr[this.casArr.length - 1]).slice(1)) + '-' +
                                String(arr.length);
            ...
            saveUpdateDataJSON() {
                ...
                this.$http({
                    ...
                    if (resp && resp.status == 200) {
                        ...
                        // lwy  调用新增发布方法
                        this.publishAddNode("stbom_infomation",this.conStBomId)
                        // lwy 新增的节点信息 发布结束
            ...
            handleUpdate(index, row) {
                ...
                //获取关联节点
                this.getRequest("/stbom/data/selectConnectInfo?selectId=" + row.value).then(resp => {
                    if (resp && resp.status == 200) {
                        console.log(resp);
            ...
            sentConnectInfo() {
                ...
                this.$http({
                    method: 'post',
                    url: "/stbom/data/saveStConnectData",
