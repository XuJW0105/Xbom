<template>
  <div class="tree-contanier" id="tree" ref="treeContainer">
    <h2 style="margin-top: 5px;color: #124880;">|&emsp;产品设计BOM系统视角结构树</h2>
    <el-row>
      <el-col :span="24" class="chart chart_left">
        <div id="treeChart" style="height: 450px">产品设计BOM系统视角结构树</div>
      </el-col>
    </el-row>
    <el-divider></el-divider>
    <h2 style="float: left; margin-top:5px;color: #124880;">|&emsp;产品设计BOM系统视角数据表格</h2>
...
<!--        添加系统设计BOM-->
        <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="120px" :inline="true"
          ...
          <el-form-item v-if="sonStatus && dialogStatus == 'create'" label="系统视角位置："
                        prop="children" :label-width="formLabelWidth" :label-positon="labelPositon">
            <el-cascader size="small" :key="isResouceShow" v-model="temp.children" placeholder="请选择系统视角位置"
                         :options="tableData" :props="TagProps" clearable @change="getCasVal"></el-cascader>
          </el-form-item>
          <el-form-item label="系统视角节点名称：" prop="name" :label-width="formLabelWidth">
            <el-input v-model="temp.name" size="small" autocomplete="off" placeholder="请输入标签名称"
                      style="width: 200px" @change="changeAssemble"></el-input>
          </el-form-item>
          <el-form-item label="系统视角节点描述：" prop="descript" :label-width="formLabelWidth">
            <el-input v-model="temp.descript" size="small" autocomplete="off" placeholder="请输入描述"
                      style="width: 200px"></el-input>
          </el-form-item>
          <el-form-item label="系统视角节点创建者：" prop="builder" :label-width="formLabelWidth">
            <el-input v-model="temp.builder" size="small" autocomplete="off" placeholder="请输入创建者"
                      style="width: 200px"></el-input>
          </el-form-item>
          <el-form-item label="系统视角节点编辑者：" prop="editor" :label-width="formLabelWidth">
            <el-input v-model="temp.editor" size="small" autocomplete="off" placeholder="请输入编辑者"
                      style="width: 200px"></el-input>
          </el-form-item>
          <el-form-item label="系统视角节点编辑时间：" prop="editorTime" :label-width="formLabelWidth">
            <el-input v-model="temp.editorTime" size="small" autocomplete="off" placeholder="请输入编辑时间"
                      style="width: 200px">
            </el-input>
          </el-form-item>
          <el-form-item label="系统视角节点版本号：" prop="version" :label-width="formLabelWidth">
          ...
          <el-form-item label="系统视角节点数据详情：" prop="detail" :label-width="formLabelWidth">
            <el-input v-model="temp.detail" size="small" autocomplete="off" placeholder="请输入数据详情"
                      style="width: 200px"></el-input>
          </el-form-item>
          <el-divider></el-divider>
          <el-form ref="dataForm2" :rules="rules" :model="tempAssemble" label-position="left" label-width="150px" :inline="true">
            <el-form-item v-if="sonStatus && dialogStatus == 'create'" label="初步装配位置："
                          prop="children" :label-width="formLabelWidth" :label-positon="labelPositon">
              <el-cascader size="small" :key="isResouceShow" v-model="tempAssemble.children" placeholder="请选择初步装配位置"
                           :options="tableEBomDataAssemble" :props="TagProps" clearable @change="getCasVal">
              </el-cascader>
            </el-form-item>
            <el-form-item label="初步装配视角节点名称：" prop="name" :label-width="formLabelWidth" >
              <el-input v-model="tempAssemble.name" size="small" autocomplete="off" placeholder="请输入标签名称"
                        style="width: 200px" :disabled = "true"></el-input>
            </el-form-item>
            <el-form-item label="初步装配视角描述：" prop="descript" :label-width="formLabelWidth">
              <el-input v-model="tempAssemble.descript" size="small" autocomplete="off" placeholder="请输入描述"
                        style="width: 200px"></el-input>
            </el-form-item>
            <el-form-item label="初步装配视角创建者：" prop="builder" :label-width="formLabelWidth">
              <el-input v-model="tempAssemble.builder" size="small" autocomplete="off" placeholder="请输入创建者"
                        style="width: 200px"></el-input>
            </el-form-item>
            <el-form-item label="初步装配视角编辑者：" prop="editor" :label-width="formLabelWidth">
              <el-input v-model="tempAssemble.editor" size="small" autocomplete="off" placeholder="请输入编辑者"
                        style="width: 200px"></el-input>
            </el-form-item>
            <el-form-item label="初步装配视角编辑时间：" prop="editorTime" :label-width="formLabelWidth">
              <el-input v-model="tempAssemble.editorTime" size="small" autocomplete="off" placeholder="请输入编辑时间"
                        style="width: 200px">
              </el-input>
            </el-form-item>
            <el-form-item label="初步装配视角版本号：" prop="version" :label-width="formLabelWidth">
              <el-select v-model="tempAssemble.version" placeholder="请选择版本" style="width: 200px" size="small">
                <el-option
                  v-for="item in options"
                  :key="item.value"
                  :label="item.label"
            ...
            <el-form-item label="初步装配视角数据详情：" prop="detail" :label-width="formLabelWidth">
              <el-input v-model="tempAssemble.detail" size="small" autocomplete="off" placeholder="请输入数据详情"
                        style="width: 200px"></el-input>
            </el-form-item>
          </el-form>
          ...
          <div v-if="dialogStatus !== 'create'">
            ...
            <el-table :data="fileDataTable" v-loading="loadingFile" border
                      style="width: 95%;margin-top: 10px;"  :key = "fileFlash">
        ...
        <div style="margin-left:-35px;" v-if="dialogStatus !== 'look'">
      ...
      <div style="float: left;margin-left:45px; width:98%" v-if="dialogStatus == 'create'">
        ...
        <div style="margin-top: 10px;">
          ...
          <el-button type="primary" @click="handleConnectENode" size="small">
            选择EBOM的节点
          </el-button>
      ...
      <div slot="footer" class="dialog-footer" style="margin-top: 50px">
        <el-upload class="upload-demo inline-block" ref="upload" :multiple="true" style="float: left;margin-left: 62%"
                   ...
                   action="/BOMFile/dataFile/uploadEBomFile" :on-preview="handlePreview"
                   :on-change="handleChange" :before-remove="beforeRemove" :on-remove="handleRemove" :limit="2"
          ...
          <el-button slot="trigger" size="small" type="primary" style="margin-left: 0px;float: left"
                     :loading="logining1" v-if="dialogStatus == 'update'">选取文件
          </el-button>
          <el-button style="float: right; margin-left: 4px;" size="small" type="success" @click="uploadFile(temp)"
                     :loading="logining2" v-if="dialogStatus == 'update'">上传
          </el-button>
        </el-upload>
...
<!--        <el-button type="primary" size="small" @click="createData(),createDataAssemble()" v-if="dialogStatus == 'create'">-->
    ...
    <el-dialog
      ...
      <!-- prop="children" :label-width="formLabelWidth" :label-positon="labelPositon"> -->
      <div>
        <el-cascader ref="cascaderMallCatergoryDf" size="medium" :key="isResouceShow" v-model="temp.children1"
                     placeholder="请选择,可输入关键字进行搜索"
                     :options="tableDfBomData" :props="TagProps" clearable filterable
      ...
      <div style="margin-left: 76%;margin-top: 20px">
			<span slot="footer" class="dialog-footer">

		    <el-button type="primary" @click="connectDfBom">关联节点</el-button>
		  </span>
      </div>
    </el-dialog>
    <!-- 选择StBOM关联节点信息和数据开始 -->
    <el-dialog
      ...
      :before-close="handleClose">
      <!-- <h4>关联节点选择</h4> -->
      <h3 style="font-weight: 700;color: #0D5599;margin-bottom: 10px;">| 请选择StBOM(设计BOM)中需要关联的节点位置：</h3>
      <div>
        <el-cascader ref="cascaderMallCatergory" size="medium" :key="isResouceShow" v-model="temp.children2"
                     placeholder="请选择,可输入关键字进行搜索"
                     :options="tableStBomData" :props="TagProps" clearable filterable
                     class="elcascader"></el-cascader>
        <!-- </el-form-item> -->
        ...
        <el-button type="primary" size="medium" @click="handleStCatergoryChange">查看节点属性信息</el-button>
      </div>
      ...
      <div style="margin-left: 76%;margin-top: 20px">
			<span slot="footer" class="dialog-footer" >
		    <el-button type="primary" @click="connectStBom" size="small">关联节点</el-button>
		  </span>
      </div>
    </el-dialog>
    <!-- 选择关联节点信息和数据结束 -->
    ...
    <el-dialog
      title="关联关系添加页面"
      :visible.sync="visitEBOM"
      width="72%"
      :before-close="handleClose">
      <!-- <h4>关联节点选择</h4> -->
      <h3 style="font-weight: 700;color: #0D5599;margin-bottom: 10px;">| 请选择EBOM(设计BOM)中需要关联的节点位置：</h3>
      <!-- <el-form-item  label="请选择定义BOM(DfBOM)的节点位置：" -->
      <!-- prop="children" :label-width="formLabelWidth" :label-positon="labelPositon"> -->
      <div>
        <el-cascader ref="cascaderMallCatergory" size="medium" :key="isResouceShow" v-model="temp.children3"
                     placeholder="请选择,可输入关键字进行搜索"
                     :options="tableEBomData" :props="TagProps" clearable filterable
                     class="elcascader"></el-cascader>
        <!-- </el-form-item> -->
        <el-select v-model="connectRelationSelect3" ref="mySelected2" placeholder="选择关联关系" style="width: 150px"
                   size="medium">
          <el-option
            v-for="item in connectOptions"
            :key="item.connectValue"
        ...
        <el-button type="primary" size="medium" @click="handleECatergoryChange">查看节点属性信息</el-button>
      </div>
      ...
      <div style="margin-left: 76%;margin-top: 20px">
			<span slot="footer" class="dialog-footer" >
		    <el-button type="primary" @click="connectEBom" size="small">关联节点</el-button>
		  </span>
      </div>
    </el-dialog>
    <!-- 选择关联节点信息和数据结束 -->
    ...
    <el-dialog title="关联关系添加页面" :visible.sync="visitOutBOM" width="85%" :before-close="handleClose">
      ...
      <!-- prop="children" :label-width="formLabelWidth" :label-positon="labelPositon"> -->
      <div>
        <el-cascader ref="cascaderMallCatergoryOut" size="medium" :key="isResouceShow" v-model="temp.children4"
                     placeholder="请选择,可输入关键字进行搜索" :options="tableOutBomData" :props="TagProps" clearable filterable
                     class="elcascader"></el-cascader>
        <!-- </el-form-item> -->
        <el-select v-model="connectRelationSelect4" ref="mySelectedOut" placeholder="选择关联关系" style="width: 150px"
                   size="medium">
      ...
      <div style="margin-left: 75%;margin-top: 10px">
				...
				<span slot="footer" class="dialog-footer" >
					...
					<el-button @click="connectOutBom" size="small" type="primary">关联节点</el-button>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogTreeVisible" width="80%">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" size="small" @click="dialogStatus === 'create' ? createData() && createDataAssemble() : updateData()">
          确认
        </el-button>
      </div>
    </el-dialog>
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        ...
        alignDir: 'center',
        textMap: {
          update: '编辑产品设计BOM(EBOM)节点信息',
          create: '添加产品设计BOM(EBOM)节点信息',
        },
        dialogStatus: '',
        dataForm2Status:false,
        ...
        connectRelationSelect3: '',
        connectRelationSelect4: '',
    ...
    mounted() {
      ...
      this.getEBOMDataAssemble();
      // this.loadFileForm();
    },
    methods: {
        //xjw 改变后赋值
        changeAssemble(){
            this.tempAssemble.name = this.temp.name;
        },
      ...
      handleConnectNodeOut() {
        this.temp.children4 = ''
        this.connectRelationSelect4 = '' //关联信息删除
      ...
      loadFileForm(fileValue) {
        this.getRequest("/BOMFile/dataFile/findEBomFileByPage?page=" + this.currentPage +
          "&size=" + this.pageSize +
      ...
      downLoadFile(index, row) {
        ...
        this.apiDownLoad("/BOMFile/dataFile/downloadEBomFileByName?fileId=" + fileId+"&fileName=" + fileName,{responseType: 'blob'}).then(
          resp => {
      ...
      deleteFile(index, row) {
        ...
        this.postRequest("/BOMFile/dataFile/deleteEBomFile?fileId=" + id).then(resp => {
          if (resp && resp.status == 200) {
            this.loadFileForm();
          } else {
            this.$message({
      ...
      //系统设计视角和初步装配视角的后端数据传过来后进行解析,相关方法开始
      // 递归寻找同级
      ...
      findSameTableAssemble(arr2, i, casArrAssemble) {
        if (i == casArrAssemble.length - 1) {
          return arr2;
        } else {
          return this.findTableAssemble(
            arr2[casArrAssemble[i].substr(casArrAssemble[i].length - 1,
              1)].children,
            (i += 1),
            casArrAssemble
          );
      ...
      // 寻找父级
      findTableAssemble(arr2, i, casArrAssemble) {
        if (i == casArrAssemble.length - 1) {
          let index2 = casArrAssemble[i].substr(casArrAssemble[i].length - 1,
            1);
          return arr2[index2];
        } else {
          return this.findTableAssemble(
      ...
      // 递归表格数据(添加)
      findAssemble(arr2, i) {
        if (i == this.casArrAssemble.length - 1) {
          return arr2[this.casArrAssemble[i].substr(this.casArrAssemble[i]
            .length - 1, 1)]
            .children;
        } else {
          return this.findAssemble(
            arr2[this.casArrAssemble[i].substr(this.casArrAssemble[i]
              .length - 1, 1)]
              .children,
            (i += 1)
          );
      ...
      // 递归表格数据(编辑)
      findSdAssemble(arr2, i, casArrAssemble) {
        if (i == casArrAssemble.length - 1) {
          let index = casArrAssemble[i].substr(casArrAssemble[i].length - 1,
            1);
          return arr2.splice(index, 1, this.tempAssemble);
        } else {
          return this.findSdAssemble(
            arr2[casArrAssemble[i].substr(casArrAssemble[i].length - 1,
              1)].children,
            (i += 1),
            casArrAssemble
      ...
      // 递归寻找同步名称
      findLableAssemble(arr2, i, casArrAssemble) {
        if (i == casArrAssemble.length - 1) {
          let index = casArrAssemble[i].substr(casArrAssemble[i].length - 1,
            1);
          return arr2[index];
        } else {
          return this.findLableAssemble(
            arr2[casArrAssemble[i].substr(casArrAssemble[i].length - 1,
              1)].children,
            (i += 1),
            casArrAssemble
      ...
      // 同步子名称
      useChildLableAssemble(arr2) {
        if (arr2 !== []) {
          arr2.forEach((item) => {
            item.parent = this.tempAssemble.name;
          });
        }
      },
      ...
      // 递归表格数据(删除)
      findDelAssemble(arr2, i, item) {
        let casArrAssemble = item.childKey;
        if (i == casArrAssemble.length - 2) {
          let index = casArrAssemble[i].substr(casArrAssemble[i].length - 1,
            1);
          arr2[index].children.forEach((it, ix, arrs) => {
            if (it == item) {
              return arrs.splice(ix, 1);
            }
          });
        } else {
          return this.findDelAssemble(
            arr2[casArrAssemble[i].substr(casArrAssemble[i].length - 1,
              1)].children,
            (i += 1),
            item
            ...
            if (this.sonStatus == false) {
              ...
              this.saveTopDataJSON();
                ...
                if (this.casArr[this.casArr.length - 1].includes('A')) {
                  this.temp.value =
                    String('C' +String(this.casArr[this.casArr.length - 1]).slice(1)) + '-' +
                    String(arr.length);
                  ...
                  this.temp.value =
                    String('C' +String(this.casArr[this.casArr.length - 1]).slice(1)) + '-' +
                    String(arr.length);
                }else if (this.casArr[this.casArr.length - 1].includes('J')) {
                  this.temp.value =
                    String('C' +String(this.casArr[this.casArr.length - 1]).slice(1)) + '-' +
                    String(arr.length);
                }else if (this.casArr[this.casArr.length - 1].includes('C')) {
                  ...
                  this.temp.value =
                    String('C' + this.casArr[this.casArr.length - 1]) + '-' +
                    String(arr.length);
                }
                ...
                console.log("此时添加的设计节点信息是",obj);
                console.log("添加设计节点的form head长这个样子",this.form.head)
                ...
                // LWY 不能删除，需要存储装配视角下的信息用，因此注释掉下方语句
                // this.resetForm('form');//清除表单数据
                this.saveUpdateDataJSON();
                //添加assemble数据
                this.createDataAssemble()
      ...
      // 添加
      createDataAssemble() {
        console.log("进入assemble创建的方法");
        this.$refs['dataForm2'].validate((valid) => {
          if (valid) {
            console.log("!!!!!!!!!!!!!!!!拿到了dataForm2的值",this.tableEBomDataAssemble);
            if (this.sonStatus == false) {
              this.tempAssemble.value = String(this.tableEBomDataAssemble.length);
              const obj = Object.assign({}, this.tempAssemble);
              obj.children = [];
              obj.parent = '';
              this.tableEBomDataAssemble.push(obj);
              this.$message({
                type: 'success',
                message: '添加成功',
              });
              ...
              let arr = this.find(this.tableEBomDataAssemble, 0);
              // console.log("!!!!!!!!!!!!!!!!拿到了arr的值");
              // console.log(arr);
              if (this.casArr[this.casArr.length - 1].includes('A')) {
                this.tempAssemble.value =
                  String('J' +String(this.casArr[this.casArr.length - 1]).slice(1)) + '-' +
                  String(arr.length);
              }else if (this.casArr[this.casArr.length - 1].includes('B')) {
                this.tempAssemble.value =
                  String('J' +String(this.casArr[this.casArr.length - 1]).slice(1)) + '-' +
              ...
              //   if(this.casArr[this.casArr.length - 1].includes('G')){
              //   this.tempAssemble.value =
              //     String(this.casArr[this.casArr.length - 1]) + '-' +
              //     String(arr.length);
              // } else
                ...
                this.tempAssemble.value =
                  String('J' + this.casArr[this.casArr.length - 1]) + '-' +
                  String(arr.length);
              }
              delete this.tempAssemble.children;
              const obj = Object.assign({}, this.tempAssemble);
              obj.children = [];
              obj.childKey = [...this.casArr, String(arr.length)];
              obj.parent = this.findTable(
                this.tableEBomDataAssemble,
                0,
                this.casArr
              ).value;
              if (this.temp.location === '2') {//这个是产品系统视角所选的子级与系统装配的视角保持一致的
                obj.location = String(
                  [...this.casArr, String(arr.length)].length
                );
              }
              ...
              // this.saveTableDataJSON();直接将之前的数据进行删除然后新增
              console.log("此时添加的装配节点信息是",obj);
              console.log("添加装配节点时，装配节点的form head信息",this.form.head);
              // console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!此时添加的节点信息是");
              this.oneBomDataTxtAssemble.childKey = JSON.stringify(obj.childKey);
              this.oneBomDataTxtAssemble.name = JSON.stringify(obj.name);
              this.oneBomDataTxtAssemble.parent = JSON.stringify(obj.parent);
              this.oneBomDataTxtAssemble.location = JSON.stringify(obj.location);
              this.oneBomDataTxtAssemble.value = JSON.stringify(obj.value);
              this.oneBomDataTxtAssemble.descript = JSON.stringify(obj.descript);
              this.oneBomDataTxtAssemble.builder = JSON.stringify(obj.builder);
              this.oneBomDataTxtAssemble.editor = JSON.stringify(obj.editor);
              this.oneBomDataTxtAssemble.editorTime = JSON.stringify(obj.editorTime);
              this.oneBomDataTxtAssemble.version = JSON.stringify(obj.version);
              this.oneBomDataTxtAssemble.detail = JSON.stringify(obj.detail);
              this.oneBomDataTxtAssemble.formJson = JSON.stringify(this.form.head);
              console.log(JSON.stringify(obj.childKey));
              // console.log("属性信息是·················");
              // console.log(this.oneBomDataTxtAssemble.childKey);
              // console.log(this.oneBomDataTxtAssemble.name);
              // console.log(this.oneBomDataTxtAssemble.parent);
              // console.log(this.oneBomDataTxtAssemble.location);
              // console.log(this.oneBomDataTxt.value);
              // console.log(this.oneBomDataTxt.descript);
              // console.log(this.oneBomDataTxt.builder);
              // console.log(this.oneBomDataTxt.editor);
              // console.log( this.oneBomDataTxt.editorTime);
              // console.log( this.oneBomDataTxt.version);
              // console.log( this.oneBomDataTxt.detail);
              console.log( "属性信息======================>"+this.oneBomDataTxtAssemble.formJson);
              console.log("assemble数据赋值完啦！！！！！让我康康！" ,this.oneBomDataTxtAssemble);

              this.saveUpdateDataJSONAssemble();//保存数据到初步装配视角
      ...
      //直接保存单条数据saveOneData
       saveUpdateDataJSON() {
        // this.saveUpdateDataJSONAssemble();
        var formJson = JSON.stringify(this.form.head);
        var UpdateJSON = JSON.stringify(this.obj);
        console.log("进入设计节点存储环节============");
        console.log("设计节点存储数据如下1存储设计节点BOM数据BomDataText",this.oneBomDataTxt);
        // this.updateOneDataTxt.message = this.obj;
        this.$http({
          method: 'post',
          url: "/ebom/data/saveOneData",
          ...
          if (resp && resp.status == 200) {
            ...
            if (fileURLStore.getItem("connectInfoListSt") != null) {
              ...
              // lwy  调用新增发布方法
              this.publishAddNode("ebom_infomation",this.conStBomId)
              // lwy 新增的节点信息 发布结束
            this.$message({
              type: 'success',
      ...
      //直接保存单条数据saveOneData
      saveUpdateDataJSONAssemble() {
        var formJson = JSON.stringify(this.form.head);
        var UpdateJSON = JSON.stringify(this.obj);
        console.log("进入装配节点存储环节============");
        console.log("装配节点存储数据如下1存储设计节点BOM数据oneBomDataTxtAssemble",this.oneBomDataTxtAssemble);
        this.$http({
          method: 'post',
          url: "/ebomAssemble/data/saveOneData",
          data: this.oneBomDataTxtAssemble,
          headers: {
            'Content-Type': 'application/json',
            'Access-Control-Allow-Origin': '*'
          }
      ...
      async getTableDataLate() {
        await this.$http({
          method: 'get',
          url: "/ebom/data/getTableDataLate",
          headers: {
            'Content-Type': 'application/json',
            'Access-Control-Allow-Origin': '*'
          }
          ...
          if (resp && resp.status == 200) {
            this.tableDataRetrun = resp.data.message;
            console.log("后端返回的最新的数据为---------");
            console.log(this.tableDataRetrun);
            console.log("后端返回的最新的数据为---------" );
            this.tableData = JSON.parse(this.tableDataRetrun);
            console.log(this.tableData)
            this.$message({
      ...
      //获取EBOM装配视角的数据
      async getEBOMDataAssemble() {
        await this.$http({
          method: 'get',
          url: "/ebomAssemble/data/getTableDataLate",
          headers: {
            'Content-Type': 'application/json',
            'Access-Control-Allow-Origin': '*'
          }
          ...
          if (resp && resp.status == 200) {
            this.tableDataAssRetrun = resp.data.message;
            // console.log("后端返回的最新的数据为---------" + this.tableDataRetrun);
            this.tableEBomDataAssemble = JSON.parse(this.tableDataAssRetrun);
            console.log("----------后端传过来的初步装配视角的数据------------------");
            console.log(this.tableEBomDataAssemble);
            console.log("----------后端传过来的初步装配视角的数据------------------");
            this.$message({
              type: 'success',
              message: '节点信息获取成功！',
      ...
      handleUpdate(index, row) {
        ...
        this.tempAssemble = Object.assign({}, row);
        ...
        //获取关联节点
        this.getRequest("/ebom/data/selectConnectInfo?selectId=" + row.value).then(resp => {
          if (resp && resp.status == 200) {
            console.log(resp);
      ...
      updateData(row) {
        ...
        row.value.length != 1 ?
          ...
          (this.sonStatus = false);
        this.temp = Object.assign({}, row); // copy obj
        this.tempAssemble = Object.assign({}, row); // copy obj
        if (row.childKey) {
          this.childKey = row.childKey;
          this.idx = row.childKey[row.childKey.length - 1];
        } else {
      ...
      getStBOMDataLate() {
        this.$http({
          method: 'get',
          url: "/stbom/data/getTableDataLate",
          headers: {
            'Content-Type': 'application/json',
            'Access-Control-Allow-Origin': '*'
          }
      ...
      getEBOMDataLate() {
        this.$http({
          ...
          if (resp && resp.status == 200) {
            this.tableDataRetrun = resp.data.message;
            // console.log("后端返回的最新的数据为---------" + this.tableDataRetrun);
            this.tableEBomData = JSON.parse(this.tableDataRetrun);
            this.$message({
              type: 'success',
              message: '节点信息获取成功！',
            })
      ...
      getMBOMDataLate() {
        this.$http({
          method: 'get',
          url: "/mbom/data/getTableDataLate",
          headers: {
            'Content-Type': 'application/json',
            'Access-Control-Allow-Origin': '*'
          }
          ...
          if (resp && resp.status == 200) {
            this.tableDataRetrun = resp.data.message;
            // console.log("后端返回的最新的数据为---------" + this.tableDataRetrun);
            this.tableMBomData = JSON.parse(this.tableDataRetrun);
            this.$message({
              type: 'success',
              message: '节点信息获取成功！',
            })
      ...
      handleMallCatergoryChange() {
        if (this.temp.children1.length != 0) {
      ...
      connectDfBom(){
          if(this.$refs['cascaderMallCatergoryDf'].getCheckedNodes()[0] == null){
              this.$message({
                  message: '请选择关联节点',
                  type: 'warning'
              });
      ...
      handleStCatergoryChange() {
        if (this.temp.children2.length != 0) {
          ...
          this.stBomArrayElementValue = arrValue2[arrValue2.length - 1];//选中关联节点名称对应的内编码
          this.stBomArrayElement = arr2[arr2.length - 1];//获取数组最后一个元素
          this.getRequest("/stbom/data/getOneNodeInfo?stBomArrayElement=" + this.stBomArrayElement).then(resp => {
            if (resp && resp.status == 200) {
              console.log(resp);
      ...
      connectStBom(){
          ...
          this.stBomArrayElement = arr2[arr2.length - 1];//获取数组最后一个元素
          this.connectInfoListSt.push({
              connectNodeName: arr2 + '',
              connectNodeValue: this.stBomArrayElementValue,
              connectRela: connectRela,
          });
          fileURLStore.setItem("connectInfoListSt", this.connectInfoListSt);
          this.visitStBOM = false;
      },
      handleECatergoryChange() {
        if (this.temp.children3.length != 0) {
          ...
          this.stBomArrayElementValue = arrValue2[arrValue2.length - 1];//选中关联节点名称对应的内编码
          this.stBomArrayElement = arr2[arr2.length - 1];//获取数组最后一个元素
          this.getRequest("/ebom/data/getOneNodeInfo?stBomArrayElement=" + this.stBomArrayElement).then(resp => {
            if (resp && resp.status == 200) {
              console.log(resp);
              this.stBomArray = resp.data.oneNodeInfo;
              this.stBomInfo = this.stBomArray[0];
      ...
      connectEBom(){
          ...
          fileURLStore.setItem("connectInfoListSt", this.connectInfoListSt);
          this.visitEBOM = false;
      },

      //获取所选中的外部应用数据节点的label
      handleMallCatergoryChangeOut() {
        if (this.temp.children4.length != 0) {
          var arr3 = this.$refs['cascaderMallCatergoryOut'].getCheckedNodes()[0].pathLabels;
          var arrValue3 = this.$refs['cascaderMallCatergoryOut'].value;
          var connectRela = this.$refs.mySelectedOut.value;
          this.outBomArrayElementValue = arrValue3[arrValue3.length - 1];
          this.outBomArrayElement = arr3[arr3.length - 1]; //获取数组最后一个元素
          this.getRequest("/outbom/data/getOneNodeInfo3?stBomArrayElement=" + this.outBomArrayElement).then(
            resp => {
              if (resp && resp.status == 200) {
                console.log(resp);
      ...
      connectOutBom(){
          ...
          this.outBomArrayElement = arr3[arr3.length - 1]; //获取数组最后一个元素
          this.connectInfoListSt.push({
              connectNodeName: arr3 + '',
              connectNodeValue: this.outBomArrayElementValue,
              connectRela: connectRela
          });
          fileURLStore.setItem("connectInfoListSt", this.connectInfoListSt);
      ...
      sentConnectInfo() {
        ...
        this.$http({
          method: 'post',
          url: "/ebom/data/saveStConnectData",
      ...
      sentConnectInfoAssemble() {
        ...
        this.$http({
          method: 'post',
          url: "/ebomAssemble/data/saveStConnectData",
          data: this.connectStInfoText,
          headers: {
            'Content-Type': 'application/json',
            'Access-Control-Allow-Origin': '*'
      ...
      handleExceed(files, fileList) {
        this.$message.warning(
          `当前限制最多选择 2个文件，本次选择了 ${files.length} 个文件，共选择了 ${files.length + fileList.length} 个文件`);
      },
      ...
      uploadFile(row) {
        ...
        this.uploadFileRequest("/BOMFile/dataFile/uploadEBomFile", uploadForm).then(resp => {
          this.fileList = [];
      ...
      selectFile() {
        if (this.dfBomArrayElement == '' || this.dfBomArrayElement == null) {
          ...
          this.getRequest("/BOMFile/dataFile/selectEBomFile?dfBomNodeName=" + dfNodeName).then(resp => {
            if (resp && resp.status == 200) {
      ...
      selectStFile() {
        if (this.stBomArrayElement == '' || this.stBomArrayElement == null) {
          ...
          this.getRequest("/BOMFile/dataFile/selectEBomFile?stBomNodeName=" + stNodeName).then(resp => {
            if (resp && resp.status == 200) {
              if (resp.data.fileName != null || this.fileName != '') {
                this.fileName = resp.data.fileName;
                this.downLoadStFile();
      ...
      downLoadStFile() {
        ...
        this.apiDownLoad("/BOMFile/dataFile/downloadEBomFileByName?fileName=" + this.fileName).then(
          resp => {
            var blob = new Blob([resp], {
              type: "application/octet-stream"
            });
      ...
      handleConnectNode() {
        this.temp.children1 = ''
        this.connectRelationSelect1 = '' //关联信息删除
        this.dfBomInfo = [];            //属性信息删除
      ...
      handleConnectStNode() {
        this.temp.children2 = ''
        this.connectRelationSelect2 = '' //关联信息删除
        this.stBomInfo = [];            //属性信息删除
      ...
      // handleConnectMNode() {
      //   this.visitMBOM = true;
      //   this.getMBOMDataLate();
      // },

      //处理关联节点开始EBOM
      handleConnectENode() {
        this.temp.children3 = ''
        this.connectRelationSelect3 = '' //关联信息删除
        this.stBomInfo = [];            //属性信息删除
        this.visitEBOM = true;
        this.getEBOMDataLate();
      },
  ...
  */
      ...
      sendrequestChange(row) {
        ...
        var tablename = 'ebom_infomation';
        var Associationtablename = 'ebom_connect_info';
      ...
      associationChange(row) {
        var submitintracoding = row.value;
        var tablename = 'ebom_connect_info';
        ...
        this.getRequest("/bomTree/associationDelete?submitNodeintracoding=" + submitNodeintracoding+"&submitintracoding=" + submitintracoding+ "&tablename=" + tablename)
          .then(resp => {
            if (resp.data.deleteNum > 0  && resp.status == 200) {
              ...
              this.getRequest("/ebom/data/selectConnectInfo?selectId=" + row.connectId).then(resp => {
                if (resp && resp.status == 200) {
                  console.log(resp);
                  this.connectInfoTable = resp.data.connectInfos;
                  this.$message({
