<template>
  <div class="tree-contanier" id="tree" ref="treeContainer">
    <h2 style="margin-top: 5px;color: #124880;">|&emsp;产品设计BOM初步装配视角结构树</h2>
    <el-row>
      <el-col :span="24" class="chart chart_left">
        <div id="treeChart" style="height: 450px">EBOM结构树加载失败</div>
      </el-col>
    </el-row>
	<el-divider></el-divider>
	<h2 style="float: left; margin-top:5px;color: #124880;">|&emsp;产品设计BOM初步装配视角数据表格</h2>
        ...
        <div style="float: left;margin-left:0px;" v-if="dialogStatus !== 'look'">
          <el-form :inline="true" :model="form" ref="form" style="margin-top: 3%">
            <div v-for="(item, index) in form.head" :key="index" style="float: left;margin-left:2.5%;">
              ...
              <div style="float: left;margin-left:88%;width: 100%;margin-top: -58px">
...
<!--     注：因装配视角来不及写故直接借用STBOM的接口进行文件上传下载-->
      ...
      closeAdd(){
          ...
          console.log("=========================>"+ this.connectInfoListSt)
			...
			downLoadFile(index, row) {
				...
				this.apiDownLoad("/BOMFile/dataFile/downloadEBomFileByName?fileId=" + fileId+"&fileName=" + fileName).then(
					resp => {
          ...
          this.$nextTick(()=>{
                ...
                this.$refs['dataForm'].validate((valid) => {
                    if (valid) {
                        if (this.sonStatus == false) {
                            ...
                            if (this.casArr[this.casArr.length - 1].includes('C')) {
                                this.temp.value =
            ...
            getTableData() {
                this.$http({
                    method: 'get',
                    url: "/ebomAssemble/data/getTableData",
            ...
            saveTopDataJSON() {
                ...
                this.$http({
                    method: 'post',
                    url: "/ebomAssemble/data/saveTopData",
                    data: this.tableDataTxt,
                    headers: {
                        'Content-Type': 'application/json',
                        'Access-Control-Allow-Origin': '*'
            ...
            saveTableDataJSON() {
                ...
                this.$http({
                    method: 'post',
                    url: "/ebomAssemble/data/saveTableData",
                    data: this.tableDataTxt,
                    headers: {
                        'Content-Type': 'application/json',
                        'Access-Control-Allow-Origin': '*'
            ...
            handleUpdate(index, row) {
                ...
                //获取关联节点
                this.getRequest("/ebomAssemble/data/selectConnectInfo?selectId=" + row.value).then(resp => {
                    if (resp && resp.status == 200) {
                        console.log(resp);
            ...
            updateData(row) {
                ...
                if (this.dialogStatus == 'update') {
                    ...
                    var tablename = 'ebom_infomation_assemble';
                    //发送对象，必须用JSON格式发送
                    this.$http({
                        method: 'post',
        ...
        */
            ...
            sendrequestChange(row) {
                ...
                var tablename = 'ebom_infomation_assemble';
                var Associationtablename = 'ebom_connect_info_assemble';
            ...
            associationDelete(row) {
                ...
                var tablename = 'ebom_connect_info_assemble';
