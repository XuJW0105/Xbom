<template>
  <div class="tree-contanier" id="tree" ref="treeContainer">
    <h2 style="margin-top: 5px;color: #124880;">|&emsp;EBOM结构树</h2>
    <el-row>
    ...
    <div style="float: left;margin-left: 20px;">
      <el-button type="primary" size="small" @click="handleCreate" icon="el-icon-circle-plus-outline"
                 style="margin: 10px 0">创建节点
      </el-button>
      <el-button @click="submitChange()" type="success" size="small">完成更改请求</el-button>

    </div>

    <el-table :data="tableData" style="width: 100%; margin-bottom: 20px" border row-key="value" stripe size="medium"
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" width="70%">
            ...
            <el-table
              ...
              <el-table-column label="操作" :align="alignDir" width="320" fixed="right">
                <template slot-scope="associationscope">
                  ...
                  <el-button @click="associationDelete(associationscope.row)" type="success" size="small"
                  >删除关联关系
                  </el-button>
                </template>
              </el-table-column>
      ...
      <div slot="footer" class="dialog-footer" style="margin-top: 50px">
        <el-upload class="upload-demo inline-block" ref="upload" :multiple="true" style="float: left;margin-left: 73%"
        ...
        <el-button type="primary" size="small" @click="dialogFormVisible = false" v-if="dialogStatus == 'look'">
          确认
        </el-button>
      </div>
    </el-dialog>
    ...
    export default {
        ...
        methods: {
            ...
            handleUpdate(index, row) {
                ...
                //获取关联节点
                this.getRequest("/stbom/data/selectConnectInfo?selectId=" + row.id).then(resp => {
                    if (resp && resp.status == 200) {
                        console.log(resp);
            ...
            handleMallCatergoryChange() {
                if (this.temp.children.length != 0) {
                    ...
                    // let arr2 = this.$refs['cascaderMallCatergory'].currentLables;
            ...
            handleStCatergoryChange() {
                if (this.temp.children.length != 0) {
                    ...
                    this.stBomArrayElementValue = arrValue2.pop();
                    this.connectInfoListSt.push({
            ...
            sentConnectInfo() {
                ...
                this.$http({
                    ...
                    if (resp && resp.status == 200) {
                        ...
                        fileURLStore.setItem("connectInfoListSt", null);
                    } else {
                        this.$message({
                            type: 'faild',
        ...
        */
            ...
            associationDelete(row) {
                var submitintracoding = row.value;
                this.getRequest("/bomTree/associationDelete?intracoding=" + submitintracoding)
                    .then(resp => {
                        if (resp.data.deleteNum > 0 && resp.data.updateintracoding > 0 && resp.status == 200) {
